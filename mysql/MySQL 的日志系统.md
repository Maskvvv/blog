...
![](http://qiniu.zhouhongyin.top/2022/07/16/1657958727-0d2070e8f84c4801adbfa03bda1f98d9.png)
...
![](http://qiniu.zhouhongyin.top/2022/07/16/1657960983-image-20220716164303483.png)
...
![](http://qiniu.zhouhongyin.top/2022/07/16/1657961375-2e5bff4910ec189fe1ee6e2ecc7b4bbe.png)
...
Bin log 用于记录了完整的逻辑记录，所有的逻辑记录在 bin log 里都能找到，所以在备份恢复时，是以 bin log 为基础，通过其记录的完整逻辑操作，备份出一个和原库完整的数据。其核心就是， redo log 记录的，即使异常重启，都会刷新到磁盘，而 bin log 记录的， 则主要用于备份。 